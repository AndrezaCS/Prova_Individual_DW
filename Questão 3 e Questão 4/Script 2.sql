...
USE DW_Individual_Andreza;

/*tratamento dos dados vazios e nulos*/
ALTER TABLE tabela_aux ADD id_aux INT PRIMARY KEY AUTO_INCREMENT;
...
/*
 inserindo as instituicoes encontradas na base de dados
 */
...
SELECT NU_IDADE,TP_SEXO,ANO_FIM_EM,ANO_IN_GRAD,CO_TURNO_GRADUACAO,TP_INSCRICAO_ADM,TP_INSCRICAO from tabela_aux;
 ...
 -- tirando as coisas que agora não são mais necessárias
DROP TRIGGER IF EXISTS TBEstudante_TR_ON_INSERT;
DROP TABLE DW_Individual_Andreza.tabela_aux;
